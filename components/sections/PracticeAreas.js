      ...
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            ...
            para satisfacer todas sus necesidades jurídicas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {practiceAreas.map((area) => (
            ...
            >
              <div className="p-8">
                <div className="text-navy-600 group-hover:text-gold-500 transition-colors duration-300 mb-4">
                  {icons[area.icon]}
                </div>
                <h3 className="text-xl font-serif font-bold text-navy-900 mb-3 group-hover:text-navy-600 transition-colors">
                  {area.title}
                </h3>
