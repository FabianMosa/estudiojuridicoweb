...
> **Arquitectura de referencia:** cuando el perfil activo es `next-tailwind`, verifica también contra **`.cursor/skills/frontend/next_architecture.md`** — no debe haber SQL inline en `app/`, secretos en handlers, ni `.env.local` versionado.
