...
| 10 | **`.cursor/commands/memory-checkpoint.md`** | Convención de checkpoints para memoria persistente en Engram. |
...
- **Checkpoint de memoria:** comando **`/memory-checkpoint`** (ver **`.cursor/commands/memory-checkpoint.md`**).
