/**
 * Página de Áreas de Práctica
 * 
 * Lista todas las áreas de especialización legal del estudio.
 * Muestra las áreas en un grid de tarjetas interactivas con íconos.
 * Incluye un CTA para casos que no encajan en las áreas mostradas.
 */
...
// Mapeo de íconos SVG (paths) para cada área
const icons = {
